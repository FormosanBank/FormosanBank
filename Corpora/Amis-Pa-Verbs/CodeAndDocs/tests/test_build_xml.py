...
def test_source_apostrophe_matches_wu_phonetic_key_and_repeated_example() -> None:
    ...
    expected = {
        ...
        "s36a-opt": ("Mana'ay kaku pananum i sayta.", "Mana^ay kako pananom i sayta.", "manaʔaj kaku pananum i sajta"),
        "s36aw0": ("Ma-na'ay", "Ma-na^ay", "manaʔaj"),
        "s36a-optw0": ("Ma-na'ay", "Ma-na^ay", "manaʔaj"),
        "s36aw0m1": ("na'ay", "na^ay", "naʔaj"),
        "s36a-optw0m1": ("na'ay", "na^ay", "naʔaj"),
    }
    affected = {}
