...
The reviewed source apostrophe now generates /ʔ/ in original PHON. Standard representation remains unresolved because the current Ortho113 profile has no apostrophe mapping; see the [open conversion decision](CodeAndDocs/README.md). Technical port readiness is pending that decision.
